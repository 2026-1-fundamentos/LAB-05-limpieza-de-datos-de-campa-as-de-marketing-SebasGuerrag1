...
def clean_campaign_data():
    ...
    campaign["month"] = campaign["month"].map(meses)
    ...
    client.to_csv(f"{salida}/client.csv", index=False)
    campaign.to_csv(f"{salida}/campaign.csv", index=False)
    economics.to_csv(f"{salida}/economics.csv", index=False)
